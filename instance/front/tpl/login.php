<form action="<?php l('login'); ?>" method="post">
    <div class="login " style="box-shadow:0 2px 7px rgba(0, 0, 0, 0.4)" >
        ...
        <div class="logo" style="color:white;font-weight:bold;">
            <img src="<?php print _MEDIA_URL ?>img/l.png" />
        </div>
        <div class="fields" id="new_login" >
            <input type="text" name="username" id="username" placeholder="Email" />
            <input type="password" name="password" id="password" placeholder="Password" />
            <div>
                <input type="submit" name="submit" value="Login" class="btn btn-small btn-warning" style="" />
            </div>
...
<style type="text/css">
    body{
        background:url(<?php print _MEDIA_URL ?>img/b.jpg);
    }
</style>
